    ...
    default:
      messageTemplate = `
        <div class="message member">
            <div class="profile-photo">GB</div>
            <div class="message-content">
                <p>${messageText}</p>
                <small>${currentTime}</small>
            </div>
...
function loadMessagesFromLocalStorage() {
  ...
  if (!localStorage.getItem('systemMessageSent')) {
      ...
      <br>
          <div class="system-message">
              <p>The ticket was opened by <b>GabbyBloxx</b> <i class="fa-solid fa-circle-check" style="color: var(--color-primary);"></i>.</p>
          </div>
          <div class="message member">
              <div class="profile-photo">GB</div>
              <div class="message-content">
                  <p>Olá, me chamo <b>GabbyBloxx</b>! Gostaria de falar com um(a) administrador(a).</p>
