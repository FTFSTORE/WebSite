...
function loadData() {
    ...
    const additionalCommission = (userCount * 2.50) - totalPaidCommission;
...
setTimeout(() => {
    window.location.href = './Tickets/gabbybloxx.html';
